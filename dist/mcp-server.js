        ...
        tools: [
            {
                ...
                description: "Search the Hexactitude knowledge base, code, and documentation using semantic similarity. Use this to find relevant content across all indexed sources (knowledge files, scripts, plugins, glossary, front/bff code, contracts).",
                inputSchema: {
                    type: "object",
                    properties: {
                        query: {
            ...
            {
                name: "search_stats",
                description: "Get statistics about the indexed content in hexa-vector database",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
